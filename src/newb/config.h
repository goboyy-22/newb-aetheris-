...
#define NL_TINT_LOW  vec3(0.72,0.88,1.18) // color tint for dark tone
#define NL_TINT_HIGH vec3(1.18,1.08,0.86) // color tint for light tone

/* Lighting */
#define NL_SUNLIGHT_INTENSITY   3.5  // 1.0 weak ~ 5.0 bright
#define NL_TORCHLIGHT_INTENSITY 1.4  // 0.5 weak ~ 3.0 bright
#define NL_SHADOW_INTENSITY     0.82  // 0.0 no shadow ~ 1.0 strong shadow
#define NL_MIN_LIGHTING_BOOST   1.75  // 1.0 minimal lighting boost for dark areas ~ 3.0 brighter dark areas
//#define NL_BLINKING_TORCH  // [toggle] flickering light
#define NL_CLOUD_SHADOW      // [toggle] cloud shadow (simple clouds only)

/* Ambient light for nether/end */
#define NL_NETHER_AMBIENT vec3(2.70,1.75,1.35)
#define NL_END_AMBIENT    vec3(1.55,1.20,2.20)

/* Sun/moon light color */
#define NL_DAWN_SUNLIGHT_COL   vec3(1.00,0.72,0.32)
#define NL_NOON_SUNLIGHT_COL   vec3(1.00,0.92,0.76)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.18,0.38,0.85)
...
#define NL_DAWN_HORIZON_COL  vec3(1.65,1.15,0.48)
#define NL_DAWN_EDGE_COL     vec3(1.25,0.82,0.38)
#define NL_DAY_ZENITH_COL    vec3(0.22,0.68,1.15)
#define NL_DAY_HORIZON_COL   vec3(0.72,1.08,1.20)
#define NL_DAY_EDGE_COL      vec3(0.92,1.08,1.16)
#define NL_NIGHT_ZENITH_COL  vec3(0.025,0.085,0.16)
#define NL_NIGHT_HORIZON_COL vec3(0.055,0.14,0.24)
#define NL_NIGHT_EDGE_COL    vec3(0.10,0.20,0.30)
#define NL_RAIN_ZENITH_COL   vec3(0.38,0.48,0.58)
#define NL_RAIN_HORIZON_COL  vec3(0.52,0.62,0.68)

#define NL_END_ZENITH_COL    vec3(0.075,0.025,0.15)
#define NL_END_HORIZON_COL   vec3(0.34,0.06,0.48)


/* Rainbow */
#define NL_RAINBOW           // [toggle] enable rainbow in sky
#define NL_RAINBOW_CLEAR 0.2 // 0.3 subtle ~ 1.0 bright during clear weather
#define NL_RAINBOW_RAIN  0.45 // 0.3 subtle ~ 1.0 bright during rain weather

/* Ore glow intensity */
#define NL_GLOW_TEX 2.5           // 0.4 weak ~ 8.0 bright
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.92 // 0.0 transparent ~ 1.0 normal
#define NL_WATER_BUMP 0.12        // 0.001 plain ~ 0.2 bumpy water
#define NL_WATER_WAVE_SPEED  0.65  // 0.2 calm ~ 2.0 turbulent
#define NL_WATER_TEX_OPACITY 0.25  // 0.0 plain water ~ 1.0 vanilla water texture
#define NL_WATER_WAVE             // [toggle] wave effect
//#define NL_WATER_REFL_MASK      // [toggle] fake water reflection mask
#define NL_WATER_TINT vec3(0.18,0.78,0.68)
...
#define NL_UNDERWATER_TINT vec3(0.42,0.90,0.82) // fog tint color when underwater
...
#define NL_CLOUD2_SHAPE vec2(0.35, 0.25)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
...
#define NL_AURORA_VELOCITY 0.035 // 0.0 static ~ 0.3 very fast
#define NL_AURORA_SCALE 0.02    // 0.002 large ~ 0.4 tiny
#define NL_AURORA_WIDTH 0.2    // 0.04 thin line ~ 0.4 thick lines
#define NL_AURORA_COL1 vec3(0.12,0.95,0.72)
#define NL_AURORA_COL2 vec3(0.24,0.35,1.00)
...
#define NL_GALAXY_VIBRANCE 0.6          // 0.0 white - 1.0 colorful
...
/* Sun/Moon */
#define NL_SUN_SIZE  1.02           // 0.3 tiny ~ 4.0 massive
#define NL_MOON_SIZE 1.02           // 0.3 tiny ~ 4.0 massive
...
#define NL_GROUND_RAIN_PUDDLES 0.75 // 0.0 no puddles ~ 1.0 puddles
...
#define NL_WEATHER_PARTICLE_SIZE 0.85 // 0.5 tiny ~ 4.0 large
