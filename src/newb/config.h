...
#define NL_EXPOSURE 1.18              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.3            // [toggle] 0.0 grayscale ~ 4.0 super saturated
#define NL_TINT                      // [toggle] enable light/dark tone tinting
#define NL_TINT_LOW  vec3(0.68,0.86,1.18) // color tint for dark tone
#define NL_TINT_HIGH vec3(1.10,1.02,0.88) // color tint for light tone
...
#define NL_NETHER_AMBIENT vec3(2.6,1.8,1.65)
#define NL_END_AMBIENT    vec3(1.55,0.95,2.05)

/* Sun/moon light color */
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.52,0.20)
#define NL_NOON_SUNLIGHT_COL   vec3(1.0,0.94,0.88)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.10,0.30,0.80)
...
/* Fog */
#define NL_FOG 0.78                // [toggle] 0.1 subtle ~ 1.0 blend with sky completely
...
#define NL_CLOUDY_FOG 0.10         // [toggle] 0.0 subtle - 0.8 dense fog clouds
...
#define NL_DAWN_ZENITH_COL   vec3(0.12,0.32,0.62)
#define NL_DAWN_HORIZON_COL  vec3(1.25,0.52,0.22)
#define NL_DAWN_EDGE_COL     vec3(1.55,0.78,0.40)
#define NL_DAY_ZENITH_COL    vec3(0.18,0.58,1.30)
#define NL_DAY_HORIZON_COL   vec3(0.72,1.10,1.42)
#define NL_DAY_EDGE_COL      vec3(1.08,1.26,1.38)
#define NL_NIGHT_ZENITH_COL  vec3(0.006,0.025,0.075)
#define NL_NIGHT_HORIZON_COL vec3(0.012,0.065,0.13)
#define NL_NIGHT_EDGE_COL    vec3(0.025,0.12,0.20)
#define NL_RAIN_ZENITH_COL   vec3(0.25,0.34,0.45)
#define NL_RAIN_HORIZON_COL  vec3(0.48,0.58,0.65)

#define NL_END_ZENITH_COL    vec3(0.035,0.004,0.075)
#define NL_END_HORIZON_COL   vec3(0.38,0.035,0.34)


/* Rainbow */
#define NL_RAINBOW           // [toggle] enable rainbow in sky
#define NL_RAINBOW_CLEAR 0.55 // 0.3 subtle ~ 1.0 bright during clear weather
#define NL_RAINBOW_RAIN  0.70 // 0.3 subtle ~ 1.0 bright during rain weather

/* Ore glow intensity */
#define NL_GLOW_TEX 2.2           // 0.4 weak ~ 8.0 bright
#define NL_GLOW_SHIMMER 0.85       // [toggle] 0.1 subtle ~ 1.0 100% shimmer
#define NL_GLOW_SHIMMER_SPEED 0.85 // 0.5 slow - 2.0 fast
...
#define NL_WATER_BUMP 0.085        // 0.001 plain ~ 0.2 bumpy water
#define NL_WATER_WAVE_SPEED  0.75  // 0.2 calm ~ 2.0 turbulent
...
#define NL_CLOUD2_SHAPE vec2(0.32, 0.28)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
#define NL_CLOUD2_DENSITY 20.0             // 1.0 blurry ~ 100.0 sharp
...
/* Aurora settings */
#define NL_AURORA 1.20           // [toggle] 0.4 dim ~ 4.0 very bright
#define NL_AURORA_VELOCITY 0.018 // 0.0 static ~ 0.3 very fast
#define NL_AURORA_SCALE 0.032    // 0.002 large ~ 0.4 tiny
#define NL_AURORA_WIDTH 0.22    // 0.04 thin line ~ 0.4 thick lines
#define NL_AURORA_COL1 vec3(0.04,0.95,0.58)
#define NL_AURORA_COL2 vec3(0.38,0.12,1.0)
...
#define NL_SHOOTING_STAR_DELAY 45.0 // 0.0 no delay ~ 100.0 long time (100 secs)

/* Galaxy */
#define NL_GALAXY_STARS 0.65           // [toggle] 0.1 dim - 4.0 bright
#define NL_GALAXY_VIBRANCE 0.55          // 0.0 white - 1.0 colorful
#define NL_GALAXY_SPEED 0.018            // 0.01 slow motion - 0.2 fast motion
...
#ifdef LOW
  /* LOW performance subpack
     Reduces the most expensive visual effects while keeping
   the main lighting, sky colors and atmosphere intact.
  */

  //Waving - reduce animation cost
  #undef NL_PLANTS_WAVE
  #define NL_PLANTS_WAVE 0.025

  #undef NL_LANTERN_WAVE
  #define NL_LANTERN_WAVE 0.04

  #undef NL_UNDERWATER_WAVE
  #define NL_UNDERWATER_WAVE 0.04

  #undef NL_WATER_WAVE
  #undef NL_WATER_WAVE_SPEED
  #define NL_WATER_WAVE_SPEED 0.45

  #undef NL_WAVE_RANGE
  #define NL_WAVE_RANGE 10.0

  //Clouds - lower quality
  #undef NL_CLOUD2_STEPS
  #define NL_CLOUD2_STEPS 7

  #undef NL_CLOUD2_DENSITY
  #define NL_CLOUD2_DENSITY 12.0
  ...
  #define NL_SHOOTING_STAR_DELAY 75.0

  //Galaxy - reduce visual complexity
  #undef NL_GALAXY_STARS
  #define NL_GALAXY_STARS 0.35

  #undef NL_GALAXY_VIBRANCE
  #define NL_GALAXY_VIBRANCE 0.35

  #undef NL_GALAXY_DAY_VISIBILITY
  #define NL_GALAXY_DAY_VISIBILITY 0.0

  //Ore glow - remove animated shimmer
  #undef NL_GLOW_SHIMMER
  #undef NL_GLOW_LEAK

  //Weather particles
  #undef NL_WEATHER_SPECK
  #define NL_WEATHER_SPECK 0.3

  #undef NL_WEATHER_PARTICLE_SIZE
  #define NL_WEATHER_PARTICLE_SIZE 0.8

  //Underwater caustics - reduce intensity
  #undef NL_CAUSTIC_INTENSITY
  #define NL_CAUSTIC_INTENSITY 1.2

  #undef NL_UNDERWATER_STREAKS
  #undef NL_UNDERWATER_STREAKS

  //Fog - slightly simpler atmosphere
  #undef NL_MIST_DENSITY
  #define NL_MIST_DENSITY 0.06

  #undef NL_CLOUDY_FOG
  #define NL_CLOUDY_FOG 0.05

  //Disable cloud/aurora reflection
